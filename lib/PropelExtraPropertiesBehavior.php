...
require_once __DIR__ . '/PropelExtraPropertiesBehaviorObjectBuilderModifier.php';

/**
 * @author Julien Muetton <julien_muetton@carpe-hora.com>
 * @package propel.generator.behavior.extra_properties
 */
class PropelExtraPropertiesBehavior extends Behavior
{
  ...
  public function getObjectBuilderModifier()
  {
    ...
    {
      $this->objectBuilderModifier = new PropelExtraPropertiesBehaviorObjectBuilderModifier($this);
    }
